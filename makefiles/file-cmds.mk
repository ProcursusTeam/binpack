...
file-cmds-setup: setup binpack-setup
	...
	[ ! -e $(BUILD_WORK)/file-cmds/file_cmds-mv.diff.done ] && patch -p1 -d $(BUILD_WORK)/file-cmds < $(BUILD_ROOT)/patches/file_cmds-mv.diff && touch $(BUILD_WORK)/file-cmds/file_cmds-mv.diff.done

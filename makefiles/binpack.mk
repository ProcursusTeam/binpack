...
BINPACK_PROJECTS = adv-cmds bash bzip2 dropbear file-cmds kext-tools ldid less libarchive ncurses network-cmds plconvert plutil shell-cmds snaputil system-cmds trustcache text-cmds uikittools vim xz
